...
# /trace-feature — Analyze a generated Electron app
...
- **"Is this secure / well-architected?"** → compare against `rules/security.md`, `docs/specs/04-architect.md`, and `rules/mvc.md`; report deviations, do not refactor (that is `/refactor-code`, on request).
