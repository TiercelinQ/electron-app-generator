...
6. If it took several attempts: produce the **cleanup report** (`rules/mvc.md` — list every dead element added during failed attempts), then offer `Veux-tu mémoriser ce point ? /electron-save-memory`.
