...
Version: [X.Y.Z] | Unreleased: [N entries pending — run /electron-release to cut a version | none]

If no project is active: "No active project. Type /electron-app to start."
